 ...
 * @author baraa
 */
public class ChekSensorsValueTest15 {
    private int locationID;
    private String abnormalMessage;
    private boolean abnormal;
    ArrayList<Sensor> sensors;
    
    public ChekSensorsValueTest15() {
        locationID=0;
        abnormalMessage="";
        abnormal = false;
    ...
    */
    ...
    public void testCheckSensorsValues() {
       ...
       TempSensor tempSensor = new TempSensor(27,1,false,20,25,1);
       LightSensor lightSensor = new LightSensor(2,2,2,false,20,25,3);
       HumiditySensor humiditySensor = new HumiditySensor(27,2,3,true,20,25,1);
