 ...
 * @author baraa
 */
public class ChekSensorsValueTest17 {
    private int locationID;
    private String abnormalMessage;
    private boolean abnormal;
    ArrayList<Sensor> sensors;
    
    public ChekSensorsValueTest17() {
        locationID=0;
        abnormalMessage="";
        abnormal = false;
    ...
    */
    ...
    public void testCheckSensorsValues() {
       ...
       TempSensor tempSensor = new TempSensor(21,1,true,20,25,1);
       LightSensor lightSensor = new LightSensor(23,24,2,true,20,25,3);
       HumiditySensor humiditySensor = new HumiditySensor(22,22,3,true,20,25,1);
