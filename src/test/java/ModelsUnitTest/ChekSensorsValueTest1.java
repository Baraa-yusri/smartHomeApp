 ...
 * @author baraa
 */
public class ChekSensorsValueTest1 {
    private int locationID;
    private String abnormalMessage;
    private boolean abnormal;
    ArrayList<Sensor> sensors;
    
    public ChekSensorsValueTest1() {
        locationID=0;
        abnormalMessage="nothing happened";
        abnormal = false;
    ...
    */
    ...
    public void testCheckSensorsValues() {
       ...
       LightSensor lightSensor = new LightSensor(27,2,2,true,20,25,3);
       ...
       String expResult = " Abnnormal Tempreture ";
