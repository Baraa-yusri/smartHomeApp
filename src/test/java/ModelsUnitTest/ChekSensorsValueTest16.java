 ...
 * @author baraa
 */
public class ChekSensorsValueTest16 {
    private int locationID;
    private String abnormalMessage;
    private boolean abnormal;
    ArrayList<Sensor> sensors;
    
    public ChekSensorsValueTest16() {
        locationID=0;
        abnormalMessage="";
        abnormal = false;
    ...
    */
    ...
    public void testCheckSensorsValues() {
       ...
       LightSensor lightSensor = new LightSensor(2,2,2,true,20,25,3);
       ...
       String expResult = " Abnnormal Case ";
