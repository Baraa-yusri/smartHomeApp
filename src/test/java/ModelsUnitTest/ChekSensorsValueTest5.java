 ...
 * @author baraa
 */
public class ChekSensorsValueTest5 {
    private int locationID;
    private String abnormalMessage;
    private boolean abnormal;
    ArrayList<Sensor> sensors;
    
    public ChekSensorsValueTest5() {
        locationID=0;
        abnormalMessage="";
        abnormal = false;
    ...
    */
    ...
    public void testCheckSensorsValues() {
       ...
       LightSensor lightSensor = new LightSensor(26,2,2,true,20,25,3);
       ...
       String expResult = " Abnnormal Light ";
